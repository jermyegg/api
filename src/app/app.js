...
var App = /** @class */ (function () {
    function App() {
        ...
        this.server = new hapi.Server(host, environment_dev_1.environment.host, port, environment_dev_1.environment.port);
    ...
    App.prototype.startSocketIO = function () {
        this.io.on('connection', function (socket) {
            socket.emid('socket_connected', { status: 'connected' });
            socket.on('sendSocketMessage', function (data) {
